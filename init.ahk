; init.ahk — mudscript Windows bootstrap / tamper-protection guardian
; Analog of macOS init.lua: the entry point. Users shortcut or startup-register this file.
; Keep this file read-only after install: attrib +r init.ahk
