...
;; Combat Warriors Macros ;;
    ...
    ;; END Click-Level Timing Helpers ;;

    ;; High Leap Assist — Internal Helpers ;;
        ; These are extracted from the Lua nested-function scope;
        ; sound constants are super-globals declared above.
    ...
    ;; END High Leap Assist — Internal Helpers ;;
    ...
    ;; Throw Trick — Internal Helpers ;;
        ; MovingCheck is passed in because it was an outer-scope local
        ; in the Lua version.
    ...
    ;; END Throw Trick — Internal Helpers ;;
